...
public class PrefKeys {
    ...
    public static final String PREF_COMMON_ENABLED_NOVELS = "pref_common_enabled_novels";
    public static final String PREF_COMMON_ENABLED_CHARACTERS = "pref_common_enabled_characters";
    public static final String PREF_COMMON_QUOTE_CONTAINS = "pref_common_quote_contains";

    public static final String PREF_COMMON_API_URL = "pref_common_api_url";
    public static final String PREF_COMMON_API_URL_DEFAULT = "http://vnaas.apsun.xyz";
    ...
    public static final String PREF_QUOTES_CHARACTER = "pref_quotes_character";
    public static final String PREF_QUOTES_NOVEL = "pref_quotes_novel";
