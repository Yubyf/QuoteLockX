package com.crossbowffs.quotelock.data.datastore
 ...
 * @author Yubyf
 */
class PreferenceDataStoreAdapter(context: Context, name: String, migrate: Boolean = false) :
    PreferenceDataStore() {

    private val dataStoreDelegate = context.getDataStoreDelegate(name, migrate = migrate)
