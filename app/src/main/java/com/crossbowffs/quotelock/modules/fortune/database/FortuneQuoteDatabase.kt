package com.crossbowffs.quotelock.modules.fortune.database
...
import com.crossbowffs.quotelock.modules.fortune.consts.FortunePrefKeys.FORTUNE_QUOTE_MAX_LENGTH
import com.crossbowffs.quotelock.modules.fortune.database.FortuneQuoteContract.DATABASE_NAME
...
val fortuneQuoteDatabase by lazy { FortuneQuoteDatabase.getDatabase(App.INSTANCE) }